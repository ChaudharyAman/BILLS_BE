...
Run ID: `system-test-1780127837616`
...
| PASS | Register free user | system-test-1780127837616-free |
| PASS | Register pro user | system-test-1780127837616-pro |
| PASS | Register admin user | system-test-1780127837616-admin |
...
| PASS | Settings get creates default record | 6a1a985f569802d7af3a532b |
...
| PASS | Client CRUD and search | system-test-1780127837616-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780127837616-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780127837616-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780127837616-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780127837616-pdf-client and system-test-1780127837616-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1a9860569802d7af3a53dd |
| PASS | Proforma create, update, convert, bulk, delete | 6a1a9860569802d7af3a5415 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1a9860569802d7af3a5448 |
| PASS | Expense create, get, list, update, delete | system-test-1780127837616-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780127837616-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780127837616-EMP |
