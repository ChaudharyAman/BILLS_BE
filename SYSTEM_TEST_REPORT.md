...
Run ID: `system-test-1779701779654`
...
| PASS | Register free user | system-test-1779701779654-free |
| PASS | Register pro user | system-test-1779701779654-pro |
| PASS | Register admin user | system-test-1779701779654-admin |
...
| PASS | Settings get creates default record | 6a141815b773484107e32b23 |
...
| PASS | Client CRUD and search | system-test-1779701779654-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1779701779654-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1779701779654-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1779701779654-invoice-a |
| PASS | Invoice bulk create | 2 created |
| PASS | PDF invoice import auto-creates missing client and item | system-test-1779701779654-pdf-client and system-test-1779701779654-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a141815b773484107e32bbf |
| PASS | Proforma create, update, convert, bulk, delete | 6a141815b773484107e32bf7 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a141815b773484107e32c29 |
| PASS | Expense create, get, list, update, delete | system-test-1779701779654-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1779701779654-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1779701779654-EMP |
