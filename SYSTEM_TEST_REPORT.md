...
Run ID: `system-test-1780128388188`
...
| PASS | Register free user | system-test-1780128388188-free |
| PASS | Register pro user | system-test-1780128388188-pro |
| PASS | Register admin user | system-test-1780128388188-admin |
...
| PASS | Settings get creates default record | 6a1a9a862e8849081c7eb805 |
...
| PASS | Client CRUD and search | system-test-1780128388188-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780128388188-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780128388188-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780128388188-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780128388188-pdf-client and system-test-1780128388188-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1a9a862e8849081c7eb8b7 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1a9a862e8849081c7eb8ef |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1a9a862e8849081c7eb922 |
| PASS | Expense create, get, list, update, delete | system-test-1780128388188-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780128388188-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780128388188-EMP |
