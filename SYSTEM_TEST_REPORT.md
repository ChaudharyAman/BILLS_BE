...
Run ID: `system-test-1780918785802`
...
| PASS | Register free user | system-test-1780918785802-free |
| PASS | Register pro user | system-test-1780918785802-pro |
| PASS | Register admin user | system-test-1780918785802-admin |
...
| PASS | Settings get creates default record | 6a26aa0341e2918daa36d2f2 |
...
| PASS | Client CRUD and search | system-test-1780918785802-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780918785802-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780918785802-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780918785802-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780918785802-pdf-client and system-test-1780918785802-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a26aa0341e2918daa36d3a8 |
| PASS | Proforma create, update, convert, bulk, delete | 6a26aa0341e2918daa36d3e0 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a26aa0441e2918daa36d413 |
| PASS | Expense create, get, list, update, delete | system-test-1780918785802-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780918785802-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780918785802-EMP |
