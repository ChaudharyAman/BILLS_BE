...
Run ID: `system-test-1779536996897`
...
| PASS | Register free user | system-test-1779536996897-free |
| PASS | Register pro user | system-test-1779536996897-pro |
| PASS | Register admin user | system-test-1779536996897-admin |
...
| PASS | Settings get creates default record | 6a119466956c55e90be8c010 |
...
| PASS | Client CRUD and search | system-test-1779536996897-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1779536996897-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1779536996897-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1779536996897-invoice-a |
| PASS | Invoice bulk create | 2 created |
| PASS | PDF invoice import auto-creates missing client and item | system-test-1779536996897-pdf-client and system-test-1779536996897-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a119467956c55e90be8c0ac |
| PASS | Proforma create, update, convert, bulk, delete | 6a119467956c55e90be8c0e4 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a119467956c55e90be8c116 |
| PASS | Expense create, get, list, update, delete | system-test-1779536996897-expense-a |
