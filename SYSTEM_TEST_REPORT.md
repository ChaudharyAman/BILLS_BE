...
Run ID: `system-test-1779696845542`
...
| PASS | Register free user | system-test-1779696845542-free |
| PASS | Register pro user | system-test-1779696845542-pro |
| PASS | Register admin user | system-test-1779696845542-admin |
...
| PASS | Settings get creates default record | 6a1404cf6cfa7758ab7b728f |
...
| PASS | Client CRUD and search | system-test-1779696845542-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1779696845542-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1779696845542-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1779696845542-invoice-a |
| PASS | Invoice bulk create | 2 created |
| PASS | PDF invoice import auto-creates missing client and item | system-test-1779696845542-pdf-client and system-test-1779696845542-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1404cf6cfa7758ab7b732b |
| PASS | Proforma create, update, convert, bulk, delete | 6a1404cf6cfa7758ab7b7363 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1404d06cfa7758ab7b7395 |
| PASS | Expense create, get, list, update, delete | system-test-1779696845542-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1779696845542-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1779696845542-EMP |
