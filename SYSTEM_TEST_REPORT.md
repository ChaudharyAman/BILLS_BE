...
Run ID: `system-test-1780054503022`
...
| PASS | Register free user | system-test-1780054503022-free |
| PASS | Register pro user | system-test-1780054503022-pro |
| PASS | Register admin user | system-test-1780054503022-admin |
...
| PASS | Settings get creates default record | 6a1979e83cd7885f44ad4ebe |
...
| PASS | Client CRUD and search | system-test-1780054503022-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780054503022-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780054503022-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780054503022-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780054503022-pdf-client and system-test-1780054503022-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1979e93cd7885f44ad4f70 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1979e93cd7885f44ad4fa8 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1979e93cd7885f44ad4fdb |
| PASS | Expense create, get, list, update, delete | system-test-1780054503022-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780054503022-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780054503022-EMP |
