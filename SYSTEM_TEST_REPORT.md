...
Run ID: `system-test-1780058405180`
...
| PASS | Register free user | system-test-1780058405180-free |
| PASS | Register pro user | system-test-1780058405180-pro |
| PASS | Register admin user | system-test-1780058405180-admin |
...
| PASS | Settings get creates default record | 6a198927e68495b19f1feebe |
...
| PASS | Client CRUD and search | system-test-1780058405180-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780058405180-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780058405180-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780058405180-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780058405180-pdf-client and system-test-1780058405180-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a198927e68495b19f1fef70 |
| PASS | Proforma create, update, convert, bulk, delete | 6a198927e68495b19f1fefa8 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a198927e68495b19f1fefdb |
| PASS | Expense create, get, list, update, delete | system-test-1780058405180-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780058405180-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780058405180-EMP |
