...
Run ID: `system-test-1779283993451`
...
| PASS | Register free user | system-test-1779283993451-free |
| PASS | Register pro user | system-test-1779283993451-pro |
| PASS | Register admin user | system-test-1779283993451-admin |
...
| PASS | Settings get creates default record | 6a0db81b94cb7fdf49a8136a |
...
| PASS | Client CRUD and search | system-test-1779283993451-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1779283993451-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1779283993451-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1779283993451-invoice-a |
| PASS | Invoice bulk create | 2 created |
| PASS | PDF invoice import auto-creates missing client and item | system-test-1779283993451-pdf-client and system-test-1779283993451-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a0db81c94cb7fdf49a81400 |
| PASS | Proforma create, update, convert, bulk, delete | 6a0db81c94cb7fdf49a81438 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a0db81c94cb7fdf49a8146a |
| PASS | Expense create, get, list, update, delete | system-test-1779283993451-expense-a |
