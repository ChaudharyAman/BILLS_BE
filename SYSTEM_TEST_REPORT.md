...
Run ID: `system-test-1780404667639`
...
| PASS | Register free user | system-test-1780404667639-free |
| PASS | Register pro user | system-test-1780404667639-pro |
| PASS | Register admin user | system-test-1780404667639-admin |
...
| PASS | Settings get creates default record | 6a1ed1be2113274fe17ea8f5 |
...
| PASS | Client CRUD and search | system-test-1780404667639-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780404667639-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780404667639-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780404667639-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780404667639-pdf-client and system-test-1780404667639-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1ed1bf2113274fe17ea9a7 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1ed1bf2113274fe17ea9df |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1ed1bf2113274fe17eaa12 |
| PASS | Expense create, get, list, update, delete | system-test-1780404667639-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780404667639-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780404667639-EMP |
