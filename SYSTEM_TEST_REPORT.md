...
Run ID: `system-test-1780146889796`
...
| PASS | Register free user | system-test-1780146889796-free |
| PASS | Register pro user | system-test-1780146889796-pro |
| PASS | Register admin user | system-test-1780146889796-admin |
...
| PASS | Settings get creates default record | 6a1ae2cc58c3917b28830347 |
...
| PASS | Client CRUD and search | system-test-1780146889796-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780146889796-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780146889796-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780146889796-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780146889796-pdf-client and system-test-1780146889796-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1ae2cc58c3917b288303f9 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1ae2cc58c3917b28830431 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1ae2cd58c3917b28830464 |
| PASS | Expense create, get, list, update, delete | system-test-1780146889796-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780146889796-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780146889796-EMP |
