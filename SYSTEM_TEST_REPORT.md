...
Run ID: `system-test-1779782371494`
...
| PASS | Register free user | system-test-1779782371494-free |
| PASS | Register pro user | system-test-1779782371494-pro |
| PASS | Register admin user | system-test-1779782371494-admin |
...
| PASS | Settings get creates default record | 6a1552e5d9009481aa250d49 |
...
| PASS | Client CRUD and search | system-test-1779782371494-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1779782371494-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1779782371494-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1779782371494-invoice-a |
| PASS | Invoice bulk create | 2 created |
| PASS | PDF invoice import auto-creates missing client and item | system-test-1779782371494-pdf-client and system-test-1779782371494-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1552e5d9009481aa250de5 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1552e5d9009481aa250e1d |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1552e6d9009481aa250e4f |
| PASS | Expense create, get, list, update, delete | system-test-1779782371494-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1779782371494-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1779782371494-EMP |
