...
Run ID: `system-test-1780928114400`
...
| PASS | Register free user | system-test-1780928114400-free |
| PASS | Register pro user | system-test-1780928114400-pro |
| PASS | Register admin user | system-test-1780928114400-admin |
...
| PASS | Settings get creates default record | 6a26ce74684c875f76184580 |
...
| PASS | Client CRUD and search | system-test-1780928114400-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780928114400-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780928114400-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780928114400-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780928114400-pdf-client and system-test-1780928114400-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a26ce74684c875f76184636 |
| PASS | Proforma create, update, convert, bulk, delete | 6a26ce74684c875f7618466e |
| PASS | Purchase order create, update, convert, bulk, delete | 6a26ce74684c875f761846a1 |
| PASS | Expense create, get, list, update, delete | system-test-1780928114400-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780928114400-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780928114400-EMP |
