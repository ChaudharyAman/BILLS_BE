...
Run ID: `system-test-1780163795613`
...
| PASS | Register free user | system-test-1780163795613-free |
| PASS | Register pro user | system-test-1780163795613-pro |
| PASS | Register admin user | system-test-1780163795613-admin |
...
| PASS | Settings get creates default record | 6a1b24d582b299304b62acd1 |
...
| PASS | Client CRUD and search | system-test-1780163795613-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780163795613-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780163795613-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780163795613-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780163795613-pdf-client and system-test-1780163795613-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1b24d682b299304b62ad83 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1b24d682b299304b62adbb |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1b24d682b299304b62adee |
| PASS | Expense create, get, list, update, delete | system-test-1780163795613-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780163795613-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780163795613-EMP |
