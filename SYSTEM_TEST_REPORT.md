...
Run ID: `system-test-1780124182371`
...
| PASS | Register free user | system-test-1780124182371-free |
| PASS | Register pro user | system-test-1780124182371-pro |
| PASS | Register admin user | system-test-1780124182371-admin |
...
| PASS | Settings get creates default record | 6a1a8a180079f952cfdba10c |
...
| PASS | Client CRUD and search | system-test-1780124182371-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780124182371-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780124182371-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780124182371-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780124182371-pdf-client and system-test-1780124182371-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1a8a180079f952cfdba1be |
| PASS | Proforma create, update, convert, bulk, delete | 6a1a8a180079f952cfdba1f6 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1a8a180079f952cfdba229 |
| PASS | Expense create, get, list, update, delete | system-test-1780124182371-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780124182371-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780124182371-EMP |
