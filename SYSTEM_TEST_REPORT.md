...
Run ID: `system-test-1776059525876`
...
| PASS | Register free user | system-test-1776059525876-free |
| PASS | Register pro user | system-test-1776059525876-pro |
| PASS | Register admin user | system-test-1776059525876-admin |
...
| PASS | Settings get creates default record | 69dc8487737c3d5063539a0c |
...
| PASS | Client CRUD and search | system-test-1776059525876-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1776059525876-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1776059525876-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1776059525876-invoice-a |
| PASS | Invoice bulk create | 2 created |
| PASS | PDF invoice import auto-creates missing client and item | system-test-1776059525876-pdf-client and system-test-1776059525876-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 69dc8488737c3d5063539a8e |
| PASS | Proforma create, update, convert, bulk, delete | 69dc8488737c3d5063539abf |
| PASS | Purchase order create, update, convert, bulk, delete | 69dc8488737c3d5063539af0 |
| PASS | Expense create, get, list, update, delete | system-test-1776059525876-expense-a |
