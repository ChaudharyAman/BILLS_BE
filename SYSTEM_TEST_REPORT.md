...
Run ID: `system-test-1779366888548`
...
| PASS | Register free user | system-test-1779366888548-free |
| PASS | Register pro user | system-test-1779366888548-pro |
| PASS | Register admin user | system-test-1779366888548-admin |
...
| PASS | Settings get creates default record | 6a0efbea14dbeea9fb8f1a71 |
...
| PASS | Client CRUD and search | system-test-1779366888548-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1779366888548-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1779366888548-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1779366888548-invoice-a |
| PASS | Invoice bulk create | 2 created |
| PASS | PDF invoice import auto-creates missing client and item | system-test-1779366888548-pdf-client and system-test-1779366888548-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a0efbea14dbeea9fb8f1b07 |
| PASS | Proforma create, update, convert, bulk, delete | 6a0efbea14dbeea9fb8f1b3f |
| PASS | Purchase order create, update, convert, bulk, delete | 6a0efbea14dbeea9fb8f1b71 |
| PASS | Expense create, get, list, update, delete | system-test-1779366888548-expense-a |
