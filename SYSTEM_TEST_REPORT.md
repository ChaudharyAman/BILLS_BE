...
Run ID: `system-test-1780318358713`
...
| PASS | Register free user | system-test-1780318358713-free |
| PASS | Register pro user | system-test-1780318358713-pro |
| PASS | Register admin user | system-test-1780318358713-admin |
...
| PASS | Settings get creates default record | 6a1d8099d71fe1dffedb9416 |
...
| PASS | Client CRUD and search | system-test-1780318358713-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780318358713-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780318358713-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780318358713-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780318358713-pdf-client and system-test-1780318358713-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1d809ad71fe1dffedb94c8 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1d809ad71fe1dffedb9500 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1d809ad71fe1dffedb9533 |
| PASS | Expense create, get, list, update, delete | system-test-1780318358713-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780318358713-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780318358713-EMP |
