...
Run ID: `system-test-1780144503148`
...
| PASS | Register free user | system-test-1780144503148-free |
| PASS | Register pro user | system-test-1780144503148-pro |
| PASS | Register admin user | system-test-1780144503148-admin |
...
| PASS | Settings get creates default record | 6a1ad97b8f390ebd84162fab |
...
| PASS | Client CRUD and search | system-test-1780144503148-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780144503148-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780144503148-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780144503148-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780144503148-pdf-client and system-test-1780144503148-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1ad97c8f390ebd8416305d |
| PASS | Proforma create, update, convert, bulk, delete | 6a1ad97c8f390ebd84163095 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1ad97c8f390ebd841630c8 |
| PASS | Expense create, get, list, update, delete | system-test-1780144503148-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780144503148-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780144503148-EMP |
