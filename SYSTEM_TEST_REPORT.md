...
Run ID: `system-test-1780128656946`
...
| PASS | Register free user | system-test-1780128656946-free |
| PASS | Register pro user | system-test-1780128656946-pro |
| PASS | Register admin user | system-test-1780128656946-admin |
...
| PASS | Settings get creates default record | 6a1a9b933c45020dfa4aab4d |
...
| PASS | Client CRUD and search | system-test-1780128656946-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780128656946-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780128656946-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780128656946-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780128656946-pdf-client and system-test-1780128656946-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1a9b933c45020dfa4aabff |
| PASS | Proforma create, update, convert, bulk, delete | 6a1a9b933c45020dfa4aac37 |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1a9b933c45020dfa4aac6a |
| PASS | Expense create, get, list, update, delete | system-test-1780128656946-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780128656946-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780128656946-EMP |
