...
Run ID: `system-test-1780163569855`
...
| PASS | Register free user | system-test-1780163569855-free |
| PASS | Register pro user | system-test-1780163569855-pro |
| PASS | Register admin user | system-test-1780163569855-admin |
...
| PASS | Settings get creates default record | 6a1b23f6e11590ce7f985fe0 |
...
| PASS | Client CRUD and search | system-test-1780163569855-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780163569855-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780163569855-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780163569855-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780163569855-pdf-client and system-test-1780163569855-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a1b23f6e11590ce7f986092 |
| PASS | Proforma create, update, convert, bulk, delete | 6a1b23f6e11590ce7f9860ca |
| PASS | Purchase order create, update, convert, bulk, delete | 6a1b23f7e11590ce7f9860fd |
| PASS | Expense create, get, list, update, delete | system-test-1780163569855-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780163569855-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780163569855-EMP |
