...
Run ID: `system-test-1780494922144`
...
| PASS | Register free user | system-test-1780494922144-free |
| PASS | Register pro user | system-test-1780494922144-pro |
| PASS | Register admin user | system-test-1780494922144-admin |
...
| PASS | Settings get creates default record | 6a20324ce9e7698793c5a7be |
...
| PASS | Client CRUD and search | system-test-1780494922144-client-a |
| PASS | Client bulk create | 2 created |
| PASS | Vendor CRUD and search | system-test-1780494922144-vendor-a |
| PASS | Item CRUD, search, and bulk | system-test-1780494922144-item-a |
| PASS | Free user is blocked from premium report | 403 returned |
| PASS | Invoice create, duplicate reject, get, search, update | system-test-1780494922144-invoice-a |
...
| PASS | PDF invoice import auto-creates missing client and item | system-test-1780494922144-pdf-client and system-test-1780494922144-pdf-item |
...
| PASS | Quote create, update, convert, bulk, delete | 6a20324ce9e7698793c5a874 |
| PASS | Proforma create, update, convert, bulk, delete | 6a20324ce9e7698793c5a8ac |
| PASS | Purchase order create, update, convert, bulk, delete | 6a20324ce9e7698793c5a8df |
| PASS | Expense create, get, list, update, delete | system-test-1780494922144-expense-a |
...
| PASS | Department create, fetch and delete | system-test-1780494922144-Engineering |
| PASS | Employee create, dynamic active list mid-month proration, salary revise | system-test-1780494922144-EMP |
